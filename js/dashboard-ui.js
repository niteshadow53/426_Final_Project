$(document).ready(function(){
    ...
    function generateRegion(coords, fname){
        $.ajax({
            url: fname,
            ...
            success: function(data){
                ...
                id = "#region-"+coords;
                for(var i = 0; i < 4; i++){
                    generateRound(id, rounds[i]['games'], coords, i);
                }
                // generateRound(id, rounds[0], coords, 0);
                // generateRound(id, rounds[1], coords, 1);
    ...
    function generateRound(id, games, region, round){
        var firstRound = [];
